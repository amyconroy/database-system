...
public class DBAutoClient
{
    ...
    public static void main(String[] args)
    {
        try {
            ...
            int index = 0;
            while(true) {
                handleNextCommand(commandLine, index, out, in);
                index++;
            }
    ...
    private static void handleNextCommand(String[] commandLine, int index, BufferedWriter out, BufferedReader in)
    {
        try {
            System.out.print("SQL:> ");
            System.in.read();
            //String command = commandLine.readLine();
            out.write(commandLine[index] + "\n");
            System.out.println(commandLine[index]);
            out.flush();
